...
/**
 * Finds pairwise pharase similarity score from the API service
 * 
 * @author adutta
 *
 */
public class SimilatityWebService {
	...
	/**
	 * initiates the connection client
	 */
	public static void init() {
		uri = Constants.WORDNET_API;
	...
	/**
	 * fetch the pairwise score from the API
	 * 
	 * @param arg1
	 * @param arg2
	 * @return
